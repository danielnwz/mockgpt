...
const translations = {
  en: {
    ...
    allChats: 'All Chats',
    noChatsForAssistant: 'No chats for this assistant yet',
    ...
    quickRewrite: 'Quick rewrite',
    rewriteShorter: 'Shorter',
    rewriteFormal: 'More formal',
    rewriteInformal: 'More informal',
    rewriteLonger: 'Longer',
  ...
  de: {
    ...
    quickRewrite: 'Schnell umformulieren',
    rewriteShorter: 'Kuerzer',
    rewriteFormal: 'Foermlicher',
    rewriteInformal: 'Informeller',
    rewriteLonger: 'Laenger',
